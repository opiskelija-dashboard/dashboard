...
var precacheConfig = [
    ["/dashboard/index.html", "1e707ab667a7afaa78ef2d181cd7a0a3"],
    [
      "/dashboard/static/css/main.51c76d39.css",
      "2ee3e46aede904e385a3929a3e3d4875"
    ],
    [
      "/dashboard/static/js/main.1b214276.js",
      "3b60ff7eebe46117493ca9ee5386b036"
    ]
  ],
  cacheName =
...
self.addEventListener("install", function(e) {
  ...
  if ("GET" === e.request.method) {
    ...
    !t &&
      ...
      (
        (n = new URL("/dashboard/index.html", self.location).toString()),
        (t = urlsToCacheKeys.has(n))
      ), t &&
      e.respondWith(
        caches
